                    ...
                    <div class="card-body">
                        ...
                        <div id="datatable-buttons_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                                ...
                                <div class="col-sm-12 col-md-6">
                                    <div class="dt-buttons btn-group flex-wrap">
                                        ...
                                        <div class="col-sm-12 col-md-6"><div id="datatable-buttons_filter" class="dataTables_filter">
                                            ...
                                            <a href="{{ route('stock.add') }}" class="btn btn-success">Add Stock</a> 
                            ...
                            <thead>
                                ...
                                aria-label="Name: activate to sort column descending">Ingredient Code</th>
                                <th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 0px;"
                                aria-label="Address: activate to sort column ascending">Category</th>
                                <th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 0px;"
                                 aria-label="Contact_Person: activate to sort column ascending">Stock Qty/Amount</th>
                                 <th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 0px;"
                                  aria-label="Phone: activate to sort column ascending">Alert Qty/Amount</th>
                                        ...
                                        <tr>
                                          ...
                                          <td style="display:flex">
                                            ...
                                            <form action="{{route('stock.delete')}}" method="POST">
                                                @csrf
                                                <input type="hidden" name="p_id" id="p_id" value="{{$stock->id}}">
