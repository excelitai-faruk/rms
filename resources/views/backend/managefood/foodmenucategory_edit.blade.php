          ...
          <div class="col-lg-6">
            ...
            <form action="{{route('update.foodmenucategory')}}" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input class="form-control" type="text" value="{{$foodmenu_edit->outlet_id}}" name="outlet_id" id="">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="example-search-input" class="col-sm-2 col-form-label">Category Name</label>
                    <div class="col-sm-10">
                      <input class="form-control" type="text" value="{{$foodmenu_edit->category_name}}" name="category_name" id="">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input class="form-control" type="text" value="{{$foodmenu_edit->description}}" name="description" id="">
                    </div>
                  </div>
