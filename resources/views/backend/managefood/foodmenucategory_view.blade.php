...
<div class="row form-gap" style="margin-top:100px">
    ...
    <div class="col-lg-7">
        <div class="card">
            <div class="card-body">
            <h4 class="card-title">Foodmenu Category View</h4>
                <div id="datatable-buttons_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6"><div id="datatable-buttons_filter" class="dataTables_filter">
                            ...
                            <a href="{{ route('add.ingredientunits') }}" class="btn btn-success"> <i class="fas fa-plus"></i>Add Foodmenu Category</a> 
                        ...
                        <thead>
                            ...
                            <tbody>
                                ...
                                @foreach ($foodmenu_view as $Foodmenu)
                                    <tr>
                                      <td>{{$Foodmenu->id}}</td>
                                      <td>{{$Foodmenu->outlet_id}}</td>
                                      <td>{{$Foodmenu->category_name}}</td>
                                      <td>{{$Foodmenu->description}}</td>
                                          
                                      <td>
                                        <a href="{{ route('edit.foodmenucategory',$Foodmenu->id)}}" class="btn btn-success">Edit</a> 
                                        <a href="{{ route('delete.foodmenucategory',$Foodmenu->id)}}" class="btn btn-danger">Delete</a>
